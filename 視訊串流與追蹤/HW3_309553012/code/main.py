...
def onmouse(event, x, y, flags, param):   #標準滑鼠互動函式
    ...
    if event==cv2.EVENT_LBUTTONDBLCLK:      #當滑鼠移動時
...
while True:
    ...
    for output in layerOutputs:
        ...
        for detection in output:
            ...
            if mouse_x > x and mouse_x < x + width and mouse_y > y and mouse_y < y + height and mouse_x != -1 and mouse_y != -1 and confidence > args["confidence"]:
                print(classID)
                mouse_y = -1
                mouse_x = -1
